                ...
                <nav class="navbar navbar-expand-lg shriradhey text-uppercase d-none d-sm-block navbar-fixed-top" id="mainNav" style="padding-top: 0rem!Important; padding-bottom: 0rem!Important; width: 100%; background-repeat: no-repeat; background-size: cover;">
                    <div class="container-fluid justify-content-center" style="padding: 0px;">
                        ...
                        <map name="image-map">
                            ...
                            <area target="" alt="4" title="Click to know about temple" href="public/visitTemple.aspx" coords="1534,289,1726,418" shape="rect">
                            <area target="" alt="5" title="Click to know about festival" href="public/festivals.aspx" coords="1726,289,1909,417" shape="rect">
                                                ...
                                                <div class="card mb-3" style="max-width: 100px;padding:5px">
                                                    ...
                                                    <div class="col-md-8 bg-transparent festCls" >
                                                      <div class="card-body bg-transparent text-white">
                                                        <h4 class="card-title"> <asp:Label ID="lblFestivalName_1" runat="server" Text='<%#Eval("p_festival_name")%>'></asp:Label></h4>
                                                        <p class="card-text"> <%#Eval("p_festival_details")%><br /><%#Eval("p_festival_day_indian_calender")%>
                                                    </p>
      <br />
